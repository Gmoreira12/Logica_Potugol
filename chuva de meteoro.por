programa
{
    ...
    se(mes_atual == 1 ou mes_atual == 2 ou mes_atual == 3){
    	  escreva("Estamos no primeiro trimestre, portanto as chuvas de meteoro são essas: "+meteoros_trimestre_um)
    	  
    }senao se(mes_atual == 4 ou mes_atual == 5 ou mes_atual == 6){
    	  escreva("Estamos no segundo trimestre, portanto as chuvas de meteoro são essas: "+meteoros_trimestre_dois)
    	  
    }senao se(mes_atual == 7 ou mes_atual == 8 ou mes_atual == 9){
    	  escreva("Estamos no terceiro trimestre, portanto as chuvas de meteoro são essas: "+meteoros_trimestre_tres)
    	  
    }senao se(mes_atual == 10 ou mes_atual == 11 ou mes_atual == 12){
    	  escreva("Estamos no quarto trimestre, portanto as chuvas de meteoro são essas: "+meteoros_trimestre_quatro)
    	  
    }senao
       escreva(" O valor digitado não corresponda a nenhum semestre do ano")
